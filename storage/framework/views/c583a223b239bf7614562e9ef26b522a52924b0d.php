        ...
        <div class="col-12 col-md-12 form-group mb-3">
            <label class="checkbox" tabindex="22">
                ...
                <div>&nbsp;&nbsp;&nbsp;
                    ...
                    nuestros <a href="<?php echo e(env('APP_URL') . '/storage/' . App\helpers::getSettingValue(2)); ?>"
...
<script>
    $(document).ready(function () {
        ...
        $('#resumenBtn').on('click', function () {
            ...
            allData.push({ name: '_token', value: '<?php echo e(csrf_token()); ?>' });
...
</style><?php /**PATH D:\Proyectos de Desarrollo\RUTAC\PROPUESTA_REGISTRO_LOGIN\rutadecrecimiento-1\resources\views/website/register/parciales/resumen.blade.php ENDPATH**/ ?>